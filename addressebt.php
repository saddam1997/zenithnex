...
if(isset($responseData['user']))
{
  ...
  $ebt_address = $responseData['user']['userEBTAddress'];
            ...
            <div class="col-sm-6 col-md-6 text-center">
                <div class="card text-white bg-success">
                    <div class="card-header text-center">
                        ...
                        <span class="text-muted">Receive EBT to this address</span>
                    </div>
                    <div class="card-body text-center bg-white text-success">
                        <a href="http://chart.apis.google.com/chart?cht=qr&chs=300x300&chl=<?php echo $new_address_BCH;?>">
                                                 <img src="http://chart.apis.google.com/chart?cht=qr&chs=300x300&chl=<?php echo $ebt_address?>" 
                                                alt="QR Code" style="width:200px;border:0;"/></a><br>
                        <h4><?php echo $ebt_address;?></h4> 
                    </div>
                </div>
