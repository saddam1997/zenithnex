    ...
    <div class="card marginTop25" style="width: 1064px;">
      <div class="card-header bg-success" style="font-size: 20px;padding: 1.5rem;">
        ...
        <div style="float: right" >
         <a type="button" href="transactionsbcc.php" style="font-size:20px;"class="btn btn-default" id="Type_All">All</a>
         <a type="button" href="sentbcc.php" style="font-size:20px;" class="btn btn-default" id="Type_Sent">Sent</a>
         <a type="button" href="recievedbcc.php" style="font-size:20px;" class="btn btn-default" id="Type_Receive">Received</a>
       </div>
     </div>
     <div class="card-body">
